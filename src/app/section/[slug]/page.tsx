...
function loadSectionVideos(sectionId: number | null): SectionVideo[] {
  const db = getDb();
  if (sectionId === null) {
    return db
      .prepare(
...
export default async function SectionPage({
  ...
  const videos = loadSectionVideos(sectionId);
    ...
    <div className="mx-auto w-full max-w-5xl px-6 pb-16">
      ...
      {videos.length === 0 ? (
        <p className="italic text-ink-soft py-16 text-center">
          Nothing new queued in this section.
        </p>
      ) : (
